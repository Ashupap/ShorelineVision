              ...
              <div className="relative p-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">
                    Serving premium seafood to destinations worldwide
                  </p>
                </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="text-white text-center z-10">
                            <div className="font-bold mb-1 text-shadow">
                              {destination.region}
                            </div>
                            <div
                              className={`${destination.size === "small" ? "text-xs" : "text-xs"} opacity-90`}
                            >
                        ...
                        >
                          ...
                          <div className="space-y-1">
                            {destination.cities.map((city, cityIndex) => (
                              ...
                              >
                                <div
                                  className={`w-1.5 h-1.5 bg-gradient-to-r ${colorClasses[destination.color]} rounded-full mr-2`}
                                ></div>
                                {city}
                              </motion.div>
                            ))}
